...
class AppStore extends Component {
  ...
  findOut = tabId => {
    this.setState({activeId: tabId, isActive: tabId})
  }
    ...
    return (
      <div className="main-container">
        ...
        <div className="apps-container">
          <ul className="each-line">
            {modified.map(eachApp => (
              <AppItem eachObj={eachApp} key={eachApp.appId} />
            ))}
          </ul>
        </div>
      </div>
